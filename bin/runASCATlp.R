...
runASCATlp <- function(lrrs, fix_ploidy = 2, interval = 0.01,
  ...
  # This function calculates the distance measure inspired by the ASCAT LogR
  # equation
  ...
  fit_mat <- do.call(rbind,
                     lapply(fits, function(r) {
                                               unlist(r)}))
  ...
  # A function for finding local minima - a 3x3 matrix in which the centre is
  # the minima
